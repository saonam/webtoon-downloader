...
test command:
python download.py --url "https://funbe13.com/나-혼자만-레벨업" --source 3 --episode 1-1
download.exe --url "https://funbe13.com/나-혼자만-레벨업" --source 3 --episode 1-1

python download.py --url "https://comic.naver.com/webtoon/list.nhn?titleId=183559&weekday=mon" --source 0 --episode 383-383
download.exe --url "https://comic.naver.com/webtoon/list.nhn?titleId=183559&weekday=mon" --source 0 --episode 383-383
"""
...
def down_funbe(url, location):
	...
	try:
		...
		imgs_links = ["https://funbe13.com" + i.get("src") for i in comic_soup.select("#toon_img > img")]
...
def funbe_main(url, location, episode_start, episode_end):
	"""
		A function that downloads comic from https://funbe13.com
	"""
	try:
	...
	try:
		links = ["https://funbe13.com" + quote(i.get("data-role")) for i in comic_soup.select("#fboardlist > table > tr > td.content__title")][::-1]  # [::-1] flips the list so it starts from episode 1
